...
for (const value of ['0.6.0-pass009', 'RebornCore', 'RebornStory', 'RebornVehicle', 'RebornRenderer', 'createNorthBerwickWorld', 'data-mode="free"', 'data-mode="run"', 'data-mode="pursuit"', 'data-mode="arena"', 'expanded-map', 'KeyM:\'map\'', '995.reborn.save.v1', 'driver-eye-v3', 'facades-atlas.webp', 'TOWNPHOTO:22', 'geometries.gableRoof', 'heroBuilding']) {

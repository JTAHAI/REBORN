...
for (const value of [
  '0.10.0-reborn-gp024', 'RebornCore', 'RebornStory', 'RebornVehicle', 'RebornRenderer',
  'createNorthBerwickWorld', 'data-mode="free"', 'data-mode="run"', 'data-mode="pursuit"',
  'data-mode="arena"', 'expanded-map', 'MAP_ZOOM_MIN', 'mapWheel', 'minimap-zoom-in',
  "KeyM:'map'", '995.reborn.save.v1', 'driver-eye-v5-grand-prix', 'facades-atlas.webp',
  'TOWNPHOTO:22', 'geometries.gableRoof', 'heroBuilding', 'groundTile=640', 'hero_sunroof',
  'mkiv_sunroof_gasket', 'Vacationland', 'renderRouteGuides', 'initGrandPrixRivals',
  'tickGrandPrixArcade', 'race-position', 'turn-hint', 'install-button', 'fullscreen-button'
]) {
...
if (html.includes("if(touch)settings.autoThrottle=true")) throw new Error('Touch must not force auto-throttle.');
...
console.log('static gameplay, PWA and North Berwick Grand Prix invariants present');
